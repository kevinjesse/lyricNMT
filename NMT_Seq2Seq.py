...
from layers import NMT_Encoder
...
class NMT_Seq2Seq(nn.Module):
    def __init__(self, \
        ...
        self.encoder = NMT_Encoder(src_size,src_embedding_size,hidden_size,n_layers,dropout_rnn=dropout_rnn,dropout_ctx=dropout_ctx,dropout_emb=dropout_emb)
